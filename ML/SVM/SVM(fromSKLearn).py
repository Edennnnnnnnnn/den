...
class SVMModel:
    def __init__(self, cv=4, cvEval=('neg_mean_squared_error', 'accuracy')):
        ...
        self.bestC = 0
        # todo
        self.hyperParams = [0.05, 0.1, 0.5, 1, 5, 10, 50, 100, 500]
    ...
    def evaluate(self):
        ...
        plt.savefig("SVMModel_1_hyperParams_vs_trainingLoss.jpg")
        ...
        plt.savefig("SVMModel_3_hyperParams_vs_cvAvgAccuracies.jpg")
