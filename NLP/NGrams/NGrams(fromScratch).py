...
class NGramsModel:
    ...
    def __str__(self):
        ...
        * NGramsModel:        
        [Supervised Learning]
        --> Unsmoothed n-grams Algorithm;
        --> Laplace Smoothing n-grams Algorithm;
        --> Deleted Interpolation Smoothing n-grams Algorithm, 


        # DATA & HELPS
        ----------------------------------------------------------------------------
        * Possible dataset can be found in the directory `data`;
        * SampleCalling Function provided;
        
        
        # FUNCTIONS
        ----------------------------------------------------------------------------
        --> setModel(self, modelInput: str = None) -> None:
        ...
        ----------------------------------------------------------------------------
        --> modelInput(self, inputDirectoryPath: str, dataType: str = None) -> None:
        ...
        ----------------------------------------------------------------------------
        --> modelInitialize(self, filename_train, N=None) -> None:
        ...
        ----------------------------------------------------------------------------
        --> modelPredict_unsmoothed(self, filename_develop: str, testChars: list, testChars_size: int, N: int) -> None:
        ...
        ----------------------------------------------------------------------------
        --> modelPredict_laplace(self, filename_develop: str, testChars: list, testChars_size: int, N: int) -> None:
        ...
        ----------------------------------------------------------------------------
        --> modelPredict_interpolation(self, filename_develop, testChars, testChars_size, N) -> None:
        ...
        ----------------------------------------------------------------------------
        --> getLambdas_heuristic(self, filename_develop, testChars) -> tuple:
        ...
        ----------------------------------------------------------------------------
        --> modelAnalyze(self, printFeedbacks: bool = False) -> None:
        ...
        ----------------------------------------------------------------------------
        --> modelOutput(self, pathOutput) -> None:
...
def sampleMain(argv, predictor=NGramsModel()):
    """
